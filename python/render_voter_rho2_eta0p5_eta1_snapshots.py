#!/usr/bin/env python3
"""Render de dos fotogramas votante rho=2 para eta=0.1 y eta=1.
...
del motor. Analogo a render_vicsek_rho2_eta1_eta5_snapshots.py, mismo estilo
visual (ejes "Posicion x"/"Posicion y", eta y va(t) como titulo debajo de cada
panel), para el modelo votante.
"""
...
CASES = [
    {
        ...
        "seed": 940000,
        "trajectory": (
            "data/illustrations/voter_rho2_eta0p5_eta1_snapshots_v1/voter/"
            "rho_2/eta_0p10000000000000001/steps_3000/realization_000_seed_940000/trajectory.csv"
        ),
    },
    {
        "eta": "1",
        ...
        "trajectory": (
            "data/illustrations/voter_rho2_eta0p5_eta1_snapshots_v1/voter/"
            "rho_2/eta_1/steps_3000/realization_000_seed_950000/trajectory.csv"
        ),
    },
]
...
def main() -> int:
    ...
    parser.add_argument(
        "--out-dir",
        type=Path,
        default=REPO_ROOT / "figures" / "voter_rho2_eta0p5_eta1_snapshots_v1",
    )
    ...
    out_path = out_dir / "voter_rho2_eta0p5_eta1_t2000_side_by_side.png"
