...
- [x] **Inicializador productivo del estado.**
  ...
  - Alcance de este cierre: cubre únicamente la construcción del estado inicial en memoria (posiciones/orientaciones uniformes, reproducibilidad, integración directa con `run_simulation`). No cerró en su momento la conversión de las densidades bajas (`1/pi`, `1/(2*pi)`, `1/(3*pi)`) a `N` entero; esa decisión se resolvió después, el 2026-08-30, como redondeo al entero más cercano (`N=32,16,11`) en `DECISIONES_PENDIENTES.md`.
